...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        # Calculate the most likely position for the nearest ghost
        ...
        # Calculate the action that minimizes the distance to this ghost

        minimizingAction = None
        minimizedDistance = float('inf')

        for action in legal:
            successorPosition = Actions.getSuccessor(pacmanPosition, action)
            successorDistance = self.distancer.getDistance(successorPosition, closestGhostPosition)

            if successorDistance < minimizedDistance:
                minimizingAction = action
                minimizedDistance = successorDistance
